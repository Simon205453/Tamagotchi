public class VisualPrints {
    ...
    public static void cowSleep() {
        System.out.println("             /( ,,,,, )\\");
        System.out.println("            _\\,;;;;;;;,/_");
        System.out.println("         .-\"; ;;;;;;;;; ;\"-.");
        System.out.println("         '.__/`_ / \\ _`\\__.'     zzZ");
    ...
    public static void dragonSleep(){
        System.out.println("             __.-/|");
        System.out.println("             \\`- -'");
        System.out.println("              =(``)=  ");
